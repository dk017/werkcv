...
const faqs = [
  ...
  {
    question: "Hoe schrijf je een goede kandidaatintroductie?",
    answer:
  ...
  {
    question: "Hoe onderbouw je dat een kandidaat aan een functie-eis voldoet?",
    answer:
  ...
  {
    question: "Wat doe je wanneer informatie niet in het CV staat?",
    answer:
  ...
  {
    question: "Wanneer gebruik je een volledig of contactvrij kandidaat-CV?",
    answer:
      "Gebruik de versie die past bij het afgesproken doel, de verwachtingen van de kandidaat en je grondslag voor delen. Een versie zonder directe contactgegevens kan directe velden verwijderen, maar werkgevers, opleidingen, projecten of tekstfragmenten kunnen de kandidaat nog herkenbaar maken. Controleer daarom het echte PDF-bestand vóór verzending.",
  },
];
...
const sources = [
  ...
  },
  {
    ...
    note: "Geeft algemene uitleg over het delen van persoonsgegevens. Je eigen grondslag en proces moeten afzonderlijk worden beoordeeld.",
  },
];
    ...
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <article>
        <header className="grid min-w-0 gap-8 py-12 sm:py-16 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-end">
          ...
          <aside className="wk-card wk-card-success min-w-0 p-6 sm:p-8">
        ...
        <section className="wk-section border-y border-[var(--wk-border)]">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight">Acht onderdelen en de bron die erbij hoort.</h2>
              <p className="mt-4 max-w-4xl text-sm leading-relaxed text-slate-600">De tabel voorkomt dat intakekennis, CV-inhoud en aannames door elkaar gaan lopen. Pas de velden aan je eigen dienstverlening aan.</p>
          <div className="mt-7 overflow-x-auto rounded-[var(--wk-radius-md)] border border-[var(--wk-border)] bg-white">
            <table className="w-full min-w-[820px] border-collapse text-left text-sm">
              <thead className="bg-[var(--wk-primary)] text-white"><tr><th className="p-4">Onderdeel</th><th className="p-4">Betrouwbare bron</th><th className="p-4">Wat de klant ziet</th></tr></thead>
              <tbody>{proposalFields.map(([field, source, output]) => <tr key={field} className="border-t border-[var(--wk-border)] align-top"><th className="p-4 font-extrabold">{field}</th><td className="p-4 font-medium text-[var(--wk-ink-muted)]">{source}</td><td className="p-4 font-medium text-[var(--wk-ink-muted)]">{output}</td></tr>)}</tbody>
            </table>
          </div>
        </section>

        <section className="wk-section">
          <div className="grid min-w-0 gap-8 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-start">
            <div>
            ...
            <div className="space-y-3">
              {evidenceRows.map((row) => (
                <div key={row.requirement} className="wk-card grid min-w-0 gap-3 p-4 sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1.3fr)_minmax(0,1.1fr)] sm:items-start">
        ...
        <section className="wk-section border-y border-[var(--wk-border)]">
          ...
          <div className="mt-8 grid gap-5 lg:grid-cols-2">
            <article className="wk-card wk-card-danger p-6">
            ...
            <article className="wk-card wk-card-success p-6">
          ...
          <div className="grid min-w-0 gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <article className="wk-card wk-card-dark p-5"><h3 className="font-black text-[var(--wk-accent)]">Intern houden</h3><ul className="mt-4 space-y-2 text-sm leading-relaxed text-white/75"><li>Interviewhypotheses</li><li>Onderhandelingsruimte</li><li>Niet-bevestigde indrukken</li><li>Persoonlijke of irrelevante gegevens</li><li>Vragen voor de volgende intake</li></ul></article>
                <article className="wk-card p-5"><h3 className="font-black text-[var(--wk-primary)]">Klantgericht delen</h3><ul className="mt-4 space-y-2 text-sm leading-relaxed text-[var(--wk-ink-muted)]"><li>Relevante samenvatting</li><li>CV-bewijs per kerneis</li><li>Bevestigde voorwaarden</li><li>Zakelijke open punten</li><li>Afgesproken CV-versie</li></ul></article>
              </div>
            </div>
            <div>
              ...
              <p className="mt-5 text-sm leading-relaxed text-slate-600">Een versie zonder directe contactgegevens kan naam- en contactvelden verwijderen, maar de kandidaat kan herkenbaar blijven door werkgevers, opleidingen, projecten, locaties, datums of een naam in lopende tekst. Controleer daarom de uiteindelijke PDF en leg binnen je bureau vast waarom en met wie de gegevens worden gedeeld.</p>
              <div className="wk-card wk-card-warning mt-5 p-4 text-sm font-semibold leading-relaxed">WerkCV garandeert geen juridische anonimiteit of AVG-compliance. Raadpleeg bij twijfel je privacyprofessional of juridisch adviseur.</div>
            </div>
          </div>
        </section>
        ...
        <section className="wk-section border-y border-[var(--wk-border)]">
          <div className="grid min-w-0 gap-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-slate-600">Herhaal niet het hele voorstel. Benoem de rol, twee relevante redenen, de bijlage en eventuele open punten die je mondeling wilt toelichten.</p>
            </div>
            <div className="wk-card p-6">
              ...
              <div className="mt-5 space-y-3 text-sm leading-relaxed text-slate-700">
                ...
                <p>Het gecontroleerde kandidaatvoorstel vind je in de bijlage. Haar exacte startdatum en ervaring met AFAS worden nog bevestigd; die punten licht ik graag toe zodra de intake is afgerond.</p>
        ...
        <section className="wk-section">
          ...
          <ol className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            ].map(([number, title, body]) => <li key={number} className="wk-card min-w-0 p-5"><span className="font-mono text-sm font-black text-[var(--wk-primary)]">0{number}</span><h3 className="mt-3 font-semibold">{title}</h3><p className="mt-2 text-sm font-medium leading-relaxed text-[var(--wk-ink-muted)]">{body}</p></li>)}
          </ol>
        </section>
        ...
        <section className="wk-section border-y border-[var(--wk-border)]">
          ...
          <div className="mt-6 space-y-3">
            {faqs.map((faq) => <details key={faq.question} className="wk-card p-4"><summary className="cursor-pointer font-semibold">{faq.question}</summary><p className="mt-3 max-w-4xl text-sm font-medium leading-relaxed text-[var(--wk-ink-muted)]">{faq.answer}</p></details>)}
          </div>
        </section>
        ...
        <section className="wk-card wk-card-dark min-w-0 p-6 sm:p-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-slate-300">Bekijk het fictieve resultaat voordat je beslist of de workflow bij je bureau past.</p>
            </div>
            <div className="flex shrink-0 flex-col gap-3">
              <AgencyContentLink href="/voor-bureaus/kennisbank/kandidaatvoorstel-voorbeeld" path={path} location="guide_bottom" intent="sample" className="wk-button wk-button-secondary">Bekijk het volledige voorbeeld</AgencyContentLink>
               <AgencyContentLink href="/agency#plan" path={path} location="guide_bottom" intent="product" className="wk-button wk-button-primary">Start MatchPack · {monthlyPrice}</AgencyContentLink>
            </div>
          </div>
        </section>
