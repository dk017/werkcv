...
export const metadata: Metadata = {
  title: "Hoe zet u een kandidaat-CV in de huisstijl van uw recruitmentbureau? | WerkCV",
  description: "Een praktische werkwijze voor CV-opmaak in bureauhuisstijl: bewaar de bron, voeg controleerbare branding toe, review de inhoud en kies een stabiele PDF-uitvoer.",
...
const guide: AgencyGuideArticleProps = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Welke workflow past bij uw bureau?",
      paragraphs: [
      ...
      table: {
        ...
        rows: [
          ...
          ["Uitvoer", "Controleer Word- en PDF-versie na export.", "De huidige klantuitvoer is PDF; een volledige en optionele versie zonder directe contactgegevens komen uit dezelfde goedgekeurde snapshot."],
        ],
      },
    },
    {
    ...
    {
      eyebrow: "Word of PDF",
      title: "Moet u Word of PDF naar een opdrachtgever sturen?",
      paragraphs: [
        "Volg eerst de instructie van de opdrachtgever. PDF is vaak praktisch voor een vaste klantweergave; Word is alleen passend wanneer de ontvanger de inhoud daadwerkelijk moet bewerken of wanneer het proces dat verlangt. WerkCV accepteert DOCX als bron, maar de huidige Agency-klantuitvoer is PDF. Claim daarom geen Word-export die niet in de workflow beschikbaar is.",
        "Word-opmaak kan verspringen door ontbrekende fonts, tabelbreedtes, handmatige pagina-einden en verschillen tussen Word-versies. Als u toch Word gebruikt, houd stijlen, tabellen en kopteksten eenvoudig en exporteer daarna een PDF die u visueel én als tekst controleert.",
      ],
      examples: [
    ...
    },
    {
      ...
      title: "Hoe voorkomt u dat inhoud onbedoeld verandert?",
      paragraphs: [
      ...
      table: {
        ...
        rows: [
          ["Bron-CV", "Interne referentie voor inhoud en bewijs.", "Niet herschrijven; bewaar toegang volgens uw eigen retentiebeleid."],
    ...
    },
    {
      ...
      examples: [
        { label: "Te commercieel", before: "“Zeer ervaren HR-adviseur die perfect past bij uw organisatie.”", after: "“Zeven jaar HR-ervaring; volgens het CV advies aan 24 teamleiders over verzuim en medewerkerontwikkeling. AFAS-ervaring en startdatum worden nog bevestigd.”" },
  ...
  faqs: [
    ...
    { question: "Moet het bestand Word of PDF zijn?", answer: "Volg de instructie van de opdrachtgever. PDF is geschikt voor een vaste klantversie; Word is alleen nodig wanneer bewerking of het proces dat verlangt. WerkCV levert momenteel PDF-klantoutput." },
    { question: "Hoe voorkomt u verspringende Word-opmaak?", answer: "Gebruik eenvoudige stijlen, beperkte tabellen, vaste marges en ingebedde fonts waar toegestaan. Exporteer daarna een PDF en controleer pagina-einden, links en tekstselectie." },
    { question: "Hoe bewaart u het originele CV?", answer: "Bewaar een ongewijzigde bron apart van klantversies, beperk toegang en leg uw eigen bewaartermijn en verwijderproces vast. WerkCV bewaart het originele uploadbestand niet als bronbestand." },
    { question: "Hoeveel versies heeft u per kandidaat nodig?", answer: "Gebruik zo weinig mogelijk versies: een bron, een werkconcept en de goedgekeurde klantversie. Voeg een versie zonder directe contactgegevens alleen toe wanneer het doel dit rechtvaardigt." },
    { question: "Hoe controleert u of inhoud niet onbedoeld is gewijzigd?", answer: "Vergelijk de uiteindelijke PDF met de bron en de bevestigde intake. Controleer vooral functietitels, data, werkgevers, opleidingen, resultaten, beschikbaarheid, tarieven en contactgegevens." },
  ],
  sources: [
