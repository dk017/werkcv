      ...
      <main className="wk-editorial-main">
        <section className="wk-editorial-hero mb-14 grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.15fr_0.85fr] lg:p-10">
          ...
          <div className="wk-editorial-card h-fit p-6">
            <h2 className="text-xl font-extrabold tracking-[-0.03em] text-[var(--wk-ink)]">De 4-delige formule voor een sterke profieltekst</h2>
        ...
        <section className="wk-editorial-card mb-14 p-6">
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-3">
            {quickAnswerCards.map((card) => (
              <article key={card.title} className="wk-editorial-card-muted p-5">
                <h3 className="text-lg font-extrabold tracking-[-0.02em] text-[var(--wk-ink)]">{card.title}</h3>
                <p className="mt-2 text-sm font-medium leading-relaxed text-[var(--wk-ink-muted)]">{card.text}</p>
              </article>
            ))}
          </div>
        ...
        <section className="wk-editorial-card mb-14 p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm font-medium leading-relaxed text-slate-700">
            Een goede profieltekst werkt pas echt als de rest van je CV dezelfde toon, bewijsvoering en vacaturefocus vasthoudt.
            Klaar met je profieltekst? Download je volledige cv voor eenmalig {cvDownloadPrice.display} bij PDF-download, zonder abonnement.
          </p>
