...
import { cv15Jarige } from "@/lib/cv-voorbeelden/examples/studenten-en-starters/cv-15-jarige";
        ...
        <section className="mb-14 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <UseExampleButton
                templateId={cv15Jarige.templateId}
                colorThemeId={cv15Jarige.colorThemeId}
                sampleCV={cv15Jarige.sampleCV}
                label="Start met ingevuld 15-jarigen CV"
              />
              <Link
                href="/cv-voorbeelden/studenten-en-starters/cv-15-jarige"
            ...
            <p className="mt-4 max-w-2xl text-sm font-medium leading-relaxed text-slate-600">
              ...
              beschikbaarheid en verantwoordelijkheid. Vervang de voorbeeldgegevens daarna door je eigen gegevens.
            </p>
          </div>
