    ...
    <main className="min-h-screen bg-[#FFFEF9] px-4 py-8 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 max-w-4xl">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-600">Controleer bewijs per functie-eis, corrigeer de brondata en maak één consistente klantintroductie met volledig of geanonimiseerd CV. Pas jouw definitieve goedkeuring gebruikt een voorstel-slot.</p>
        </section>
        ...
        <section className="mt-10 grid gap-4 border-t-2 border-slate-900 pt-6 text-sm text-slate-600 md:grid-cols-3">
          ...
          <div><p className="font-black text-slate-900">2. Corrigeer</p><p className="mt-1 leading-relaxed">Eén gecontroleerde bron voedt het voorblad, volledige CV en geanonimiseerde concept.</p></div>
