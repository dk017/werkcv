...
import AgencyPilotLink from "@/components/agency/AgencyPilotLink";
...
export const metadata: Metadata = {
  ...
  description:
    "Van kandidaat-CV en vacature naar bewijs per functie-eis, recruiter-review en een branded volledig of geanonimiseerd kandidaatvoorstel.",
...
const planItems = [
  ...
  "Branded volledig en geanonimiseerd voorstelpakket",
...
const faqs = [
  {
    ...
    answer: "Een goedgekeurd voorstel bestaat uit een branded introductiepagina, de door de recruiter bevestigde voorstelgegevens en een volledig of geanonimiseerd CV. De begeleidende e-mail kan direct worden gekopieerd. De interne bewijsmatrix en recruiternotities worden niet meegestuurd.",
  },
  {
  ...
  {
    question: "Is de geanonimiseerde versie automatisch AVG-proof?",
    answer: "Nee. WerkCV verwijdert directe identificatoren zoals naam en contactgegevens en markeert het resultaat als concept. De recruiter moet bedrijfsnamen, scholen, projecten, de grondslag voor verwerking en het doel van delen zelf controleren.",
  },
  {
  ...
  {
    question: "Kan ik eerst één echte kandidaatcase testen?",
    answer: "Ja. Vraag een begeleide pilot aan met zakelijke contactgegevens. Stuur nog geen kandidaat-CV via het openbare formulier; we spreken eerst de veilige aanlevering, toestemming en retentie af.",
  },
];

function CheckoutAction({ location }: { location: string }) {
  if (!isAgencyDodoConfigured()) return <AgencyPilotLink location={`${location}_pilot_fallback`} className={primaryButtonClass} />;
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="grid gap-10 py-14 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black tracking-tight sm:text-6xl">Van kandidaat-CV en vacature naar een compleet klantvoorstel.</h1>
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-600">WerkCV koppelt functie-eisen aan bewijs uit het CV, laat ontbrekende informatie zichtbaar en maakt een branded kandidaatvoorstel met volledig of geanonimiseerd CV. Jij controleert en keurt alles goed voordat het naar de opdrachtgever gaat.</p>
            <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              <a href="#voorbeeld" className={primaryButtonClass}>Bekijk een compleet voorbeeld</a>
              <AgencyPilotLink location="agency_hero" className="text-sm font-black text-slate-700 underline decoration-2 underline-offset-4 hover:text-emerald-700" />
            </div>
            <div className="mt-7 flex flex-wrap gap-2 text-xs font-bold text-slate-600"><span className="border border-slate-300 bg-white px-3 py-2">Bewijs, geen aannames</span><span className="border border-slate-300 bg-white px-3 py-2">Menselijke goedkeuring</span><span className="border border-slate-300 bg-white px-3 py-2">NL + EN</span><span className="border border-slate-300 bg-white px-3 py-2">Volledig + geanonimiseerd</span></div>
          </div>

          <div className="relative border-2 border-slate-900 bg-white p-5 shadow-[8px_8px_0px_0px_rgba(78,205,196,1)] sm:p-7">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">WerkCV MatchPack</p><h2 className="mt-2 text-2xl font-black">Eén review. Eén goedgekeurde bron. Twee klantpakketten.</h2>
        ...
        <section id="hoe-het-werkt" className="py-14 sm:py-20">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">{[
            ...
            ["4", "Keur één snapshot goed", "Download een volledig of geanonimiseerd voorstel en kopieer de begeleidende e-mail."],
        ...
        <section id="pilot" className="grid gap-8 border-y-2 border-slate-900 py-14 lg:grid-cols-[0.72fr_1.28fr] lg:items-start"><div><p className="text-xs font-black uppercase tracking-[0.18em] text-emerald-700">Begeleide eerste case</p><h2 className="mt-3 text-3xl font-black tracking-tight">Test één echte kandidaatcase veilig.</h2><p className="mt-4 text-sm leading-relaxed text-slate-600">Vertel ons hoe jullie nu kandidaten voorstellen. We spreken eerst de veilige aanlevering, toestemming en gewenste output af. Upload nog geen kandidaat-CV in dit openbare formulier.</p><div className="mt-5 border-2 border-slate-200 bg-white p-4 text-xs font-semibold leading-relaxed text-slate-600"><strong className="text-slate-900">Geschikt voor de pilot:</strong> recruitmentbureaus, detacheerders en gespecialiseerde staffingteams die regelmatig een CV, vacature en recruitercontext samenbrengen.</div></div><B2BLeadForm pageType="agency" pagePath="/agency" title="Vraag één kandidaatcase aan" description="Geen generieke demo: we beoordelen of de huidige workflow bij jullie voorstelproces past en spreken één veilige test af." submitLabel="Vraag pilot aan" audienceLabel="Type organisatie" audienceOptions={[{ value: "recruitment", label: "Recruitmentbureau" }, { value: "staffing", label: "Uitzend- of staffingbureau" }, { value: "detachment", label: "Detacheerder of consultancy" }, { value: "other", label: "Anders" }]} rolePlaceholder="Bijvoorbeeld eigenaar of recruitment lead" volumeLabel="Kandidaatvoorstellen per maand" goalLabel="Hoe maken en versturen jullie nu een kandidaatvoorstel?" goalPlaceholder="Beschrijf de huidige stappen, gebruikte documenten en waar tijd of kwaliteitsverlies ontstaat." notesPlaceholder="Optioneel: gebruikte ATS, gewenste huisstijl of type vacatures. Geen persoonsgegevens van kandidaten." successMessage="Ontvangen. We nemen contact op om de pilot, veilige aanlevering en gewenste output af te spreken." /></section>
        ...
        <section className="border-2 border-slate-900 bg-slate-950 p-6 text-white shadow-[6px_6px_0px_0px_rgba(250,204,21,1)] sm:p-8"><div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-xs font-black uppercase tracking-[0.18em] text-yellow-300">Van CV-bestand naar klantvoorstel</p><h2 className="mt-2 text-3xl font-black">Laat eerst het complete voorbeeld overtuigen.</h2><p className="mt-2 max-w-2xl text-sm leading-relaxed text-slate-300">Test daarna één echte kandidaatcase of start direct met het Agency-plan.</p></div><div className="flex flex-col gap-3 sm:items-end"><AgencyPilotLink location="agency_bottom" className="inline-flex min-h-12 items-center justify-center border-2 border-white bg-yellow-300 px-5 py-3 text-sm font-black text-slate-950" /><CheckoutAction location="agency_bottom_checkout" /></div></div></section>
      </main>
