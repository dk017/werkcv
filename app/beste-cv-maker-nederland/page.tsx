  ...
  return (
    <IntentLandingPage
      ...
      relatedLinks={[
        ...
        {
          href: "/cv-gids/werkcv-vs-livecareer",
          label: "LiveCareer alternatief",
          body: "Vergelijk WerkCV met een grotere internationale builder met subscriptionmodel, Word-downloads en veel templatekeuze.",
        },
        {
