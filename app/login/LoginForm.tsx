...
const loginCopy = {
  nl: {
    ...
    agencyIntro: "Gebruik hetzelfde e-mailadres als bij je Agency-billing tier. Je persoonlijke CV's en MatchPack-documenten blijven gescheiden.",
  ...
  en: {
    ...
    agencyIntro: "Use the same email address as your Agency billing tier. Your personal CVs and MatchPack documents stay separate.",
