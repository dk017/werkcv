...
const sections: ToolSection[] = [
    ...
    },
    {
        ...
        tools: [
            {
                href: "/cv-check",
                title: "AI CV-check en ATS checker",
                description: "Zie wat een ATS uit je cv leest, je cijfer en de drie punten die je als eerste verbetert, met Nederlandse regels.",
                badge: "AI",
                badgeClass: "bg-teal-100 text-teal-800 border-teal-300",
            },
            {
                ...
                description: "Zie per eis uit de vacature of je cv die aantoont, met citaten uit de vacature en je cv.",
                badge: "AI",
                badgeClass: "bg-teal-100 text-teal-800 border-teal-300",
            },
            {
        ...
        <main>
            <div className="wk-container py-12">
                ...
                <p className="mt-8 text-sm leading-7 text-[var(--wk-ink-muted)]">
                    Zoek je naast onze tools ook meer bronnen voor je sollicitatie? Bekijk de{' '}
                    <Link href="/cv-tools-links" className="font-semibold text-[var(--wk-primary)] underline decoration-[var(--wk-accent)] underline-offset-4">
