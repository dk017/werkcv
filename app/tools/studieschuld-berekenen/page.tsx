    ...
    <ToolPageShell
      ...
      bottomCta={
        <ToolToCvCTA
          ...
          eyebrow="Volgende stap bij je baanbeslissing"
          title="Vergelijk je maandlast met een volgende baan of salarisstap"
          ...
          insightText="Gebruik je DUO-berekening naast je salarisverwachting als je solliciteert voor een eerste baan, betere rol of hoger inkomen."
          intent="salary"
        />
      }
    >
