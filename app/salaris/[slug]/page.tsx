...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = page.metaTitle ?? `Salaris ${page.roleLabel} 2026 - CBS Mediaan en Salarisband | WerkCV`;
  const description =
    page.metaDescription ??
    (`Bekijk voor ${page.roleLabel} in Nederland de CBS-salarisband voor 32, 36 en 40 uur. ` +
      `Zie direct het 25e percentiel, de mediaan en de bovenkant van de markt op basis van ${benchmark.dataYear} data.`);
        ...
        <RelatedToolsSection
          ...
          tools={[
            ...
            },
            {
              ...
              description: "Zet je salarisdoel om naar een sollicitatieklare CV-versie zonder abonnementsval.",
              badge: "CV",
            },
          ]}
        />
