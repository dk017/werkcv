...
const examples = [
  ...
  },
  {
    ...
    label: "Functie",
    bestFor: "Projectrollen waar planning, stakeholdermanagement en voorspelbare oplevering centraal staan.",
    tone: "Beheerst, verantwoordelijk en resultaatgericht",
    body: "Sterk voorbeeld als je wilt laten zien dat je complexe trajecten kunt sturen zonder te vervallen in vaag managementjargon.",
    notFor: "Puur specialistische functies zonder projectverantwoordelijkheid of delivery-focus.",
  },
  {
