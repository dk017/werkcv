...
export default function AgencyMatchPackWorkspace({
  ...
  const saveDraft = async () => {
    ...
    try {
      ...
      setIsDirty(false);
      setCheckedItems([false, false, false]);
      setNotice("Concept opgeslagen. De volledige en geanonimiseerde versie gebruiken nu dezelfde gecontroleerde brondata.");
          ...
          <div className="space-y-6">
            ...
            {activeResult ? (
              <>
                ...
                <section className="border-2 border-slate-900 bg-white p-5 sm:p-6">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-600">Deze velden voeden zowel het volledige als het geanonimiseerde CV. Corrigeer alleen extractiefouten en voeg geen onbevestigde claims toe.</p>
                    </div>
                ...
                <section className="border-2 border-slate-900 bg-white p-5 sm:p-6">
                  <div className="flex flex-wrap items-end justify-between gap-3"><div><p className="text-xs font-black uppercase tracking-[0.16em] text-emerald-700">Twee klantpakketten</p><h3 className="mt-2 text-2xl font-black">Volledig en geanonimiseerd kandidaatvoorstel</h3></div><p className="text-xs font-semibold text-slate-500">Elk pakket bevat een voorblad en het gecontroleerde CV</p></div>
