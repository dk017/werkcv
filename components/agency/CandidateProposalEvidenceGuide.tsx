    ...
    <>
      <section className="wk-container py-12 sm:py-16">
        <div className="grid gap-8 lg:grid-cols-[0.74fr_1.26fr] lg:items-start">
          <div>
            <p className="wk-eyebrow">{isEnglish ? "How to read the result" : "Zo leest u de uitslag"}</p>
          ...
          <div className="overflow-x-auto rounded-[var(--wk-radius-lg)] border border-[var(--wk-border)] bg-white shadow-[var(--wk-shadow-sm)]">
            <table className="w-full min-w-[680px] border-collapse text-left text-sm">
              <thead className="bg-[var(--wk-surface-muted)]"><tr><th className="p-4">{isEnglish ? "Status" : "Status"}</th><th className="p-4">{isEnglish ? "What the tool found" : "Wat de tool vond"}</th><th className="p-4">{isEnglish ? "Recruiter action" : "Actie voor recruiter"}</th></tr></thead>
              <tbody>
                {(isEnglish ? [
