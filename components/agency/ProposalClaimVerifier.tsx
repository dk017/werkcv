...
function copy(locale: Locale) {
  const en = locale === "en";
  return {
    title: en ? "Check every client-facing claim before you send it." : "Controleer iedere klantclaim vóór verzending.",
    intro: en
    ...
    methodology: en ? "/en/candidate-proposal-checker/methodology" : "/voor-bureaus/methodologie/claim-verifier",
...
export default function ProposalClaimVerifier({ locale = "nl" }: { locale?: Locale }) {
  const t = copy(locale);
