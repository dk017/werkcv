...
export const cvMakenInHetEngels: BlogArticle = {
    slug: 'cv-maken-in-het-engels',
    ...
    faq: [
        ...
        },
        {
            ...
            answer: 'Kies één taal en houd het consequent. Een tweetalig CV (deels Nederlands, deels Engels) ziet er onprofessioneel uit en verwaart de lezer. Als de werkgever een Engels CV vraagt, is de gehele inhoud in het Engels.',
        },
        {
        ...
        },
        {
            ...
            answer: '"Freelancer" is internationaal direct begrijpelijk. Je kunt ook "Independent Contractor" of "Self-employed" gebruiken. Noteer als functietitel: "Freelance [vakgebied]" gevolgd door je KvK-registratie is niet nodig op een internationale CV.',
        },
        {
