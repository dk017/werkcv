...
export const sollicitatiegesprekVoorbereiden: BlogArticle = {
    ...
    sections: [
        {
            id: 'belang-voorbereiding',
            title: 'Waarom is goede voorbereiding essentieel?',
            answerCapsule: 'Recruiters vormen hun oordeel binnen de eerste 90 seconden. Een goed voorbereide kandidaat start zelfverzekerd, geeft betere antwoorden en maakt meer kans op de functie.',
            content: [
        ...
        {
            id: 'bedrijf-onderzoeken',
            title: 'Onderzoek het bedrijf grondig',
            answerCapsule: 'Onderzoek voor het gesprek: het product of de dienst, de missie, recente nieuws, de jaarcijfers, en het LinkedIn-profiel van je gesprekspartner.',
            content: [
        ...
        },
        {
            ...
            title: 'De 10 meest gestelde sollicitatievragen',
            answerCapsule: 'De meestgestelde sollicitatievragen zijn voorspelbaar. Bereid op alle 10 een helder antwoord voor en oefen ze hardop — zo klinken ze in het gesprek vloeiend en zelfverzekerd.',
            content: [
        ...
        {
            id: 'star-methode',
            title: 'De STAR-methode: structuur voor gedragsvragen',
            answerCapsule: 'STAR staat voor Situatie, Taak, Actie, Resultaat. Gebruik deze structuur voor concrete antwoorden op gedragsvragen — het maakt je verhaal verifieerbaar en overtuigend.',
            content: [
        ...
        {
            id: 'eigen-vragen-stellen',
            title: 'Goede eigen vragen stellen aan de interviewer',
            answerCapsule: 'Bereid minimaal 5 eigen vragen voor. Goede vragen tonen oprechte interesse in de functie en het team — en helpen jou om te beoordelen of dit bedrijf bij je past.',
            content: [
        ...
        },
        {
            ...
            title: 'Kleding: hoe kleed je je voor een sollicitatiegesprek?',
            answerCapsule: 'Kleed je altijd een stap formeler dan de verwachte dresscode van het bedrijf. Twijfel je? Kies altijd voor netter — je kunt een stropdas uitdoen, maar je kunt geen pak aantrekken ter plekke.',
            content: [
        ...
        {
            id: 'lichaamstaal',
            title: 'Lichaamstaal en non-verbale communicatie',
            answerCapsule: 'Lichaamstaal communiceert meer dan je woorden: een stevige handdruk, oogcontact en een open houding signaleren zelfvertrouwen en openheid voor de recruiter.',
            content: [
        ...
        {
            id: 'online-gesprekken',
            title: 'Tips voor online sollicitatiegesprekken',
            answerCapsule: 'Test techniek vooraf, kijk in de camera (niet naar je eigen beeld), zorg voor goede verlichting en een rustige achtergrond, en kleed je volledig professioneel.',
            content: [
        ...
        {
            id: 'zwakke-punten-beantwoorden',
            title: 'De zwakke punten vraag: hoe beantwoord je die goed?',
            answerCapsule: 'Noem een echte zwakte die niet kerncritisch is voor de functie, en beschrijf direct de concrete stap die je al hebt genomen om eraan te werken.',
            content: [
        ...
        {
            id: 'na-het-gesprek',
            title: 'Na het sollicitatiegesprek: wat doe je?',
            answerCapsule: 'Stuur binnen 24 uur een persoonlijke bedankmail. Slechts 24% van de kandidaten doet dit — het is een eenvoudig en effectief onderscheidingsmiddel.',
            content: [
    ...
    faq: [
        {
            question: 'Hoe lang duurt een gemiddeld sollicitatiegesprek?',
            answer: 'Een eerste sollicitatiegesprek duurt gemiddeld 45 tot 60 minuten. Vervolggesprekken kunnen variëren: van 30 minuten (korte verificatie) tot 2-3 uur bij assessment-achtige gesprekken. Vraag vooraf naar de verwachte duur zodat je je agenda goed plant.',
        },
        {
            question: 'Wat moet ik meenemen naar een sollicitatiegesprek?',
            answer: 'Neem mee: een geprint exemplaar van je cv (meerdere kopieën als je met meerdere mensen spreekt), een notitieblok met pen, je lijst met voorbereide vragen en eventueel een portfolio. Zorg dat je telefoon op stil staat.',
        },
        {
            question: 'Hoe ga ik om met zenuwen?',
            answer: 'Goede voorbereiding is het beste middel tegen zenuwen. Oefen je antwoorden hardop, doe de avond voor je gesprek een proefrit naar de locatie als het fysiek is, doe ademhalingsoefeningen en bedenk dat een beetje spanning normaal is en je scherp houdt. Zenuwen zijn pas een probleem als je er geen controle over hebt.',
        },
        {
            question: 'Mag ik aantekeningen maken tijdens het gesprek?',
            answer: 'Ja, aantekeningen maken wordt als positief gezien — het toont dat je het gesprek serieus neemt. Vraag beleefd of het oké is en noteer kernpunten, antwoorden op je vragen en toezeggingen over het vervolg. Gebruik een notitieblok, geen laptop of telefoon.',
        },
        {
            question: 'Hoe beantwoord ik de vraag over mijn zwakke punten?',
            answer: 'Noem een echte zwakte die niet kerncritisch is voor de functie en beschrijf direct de concrete stap die je al hebt gezet om eraan te werken. Voorbeeld: "Ik had moeite met delegeren maar heb daarvoor een cursus gevolgd en leid inmiddels een team van 4." Vermijd quasi-zwaktes als "ik ben te perfectionistisch".',
        },
        {
            question: 'Wanneer bespreek ik salaris in het sollicitatiegesprek?',
            answer: 'Vermijd salarisonderhandeling in het eerste gesprek tenzij de werkgever het aansnijdt. Als je er naar gevraagd wordt, geef dan een range gebaseerd op marktonderzoek (Loonwijzer, Glassdoor, CBS-salarisschalen). Zeg: "Op basis van mijn onderzoek en ervaring zoek ik naar een package van X tot Y — is dat in lijn met jullie budget?"',
        },
        {
            question: 'Hoe bereid ik me voor op een online sollicitatiegesprek?',
            answer: 'Test een uur van tevoren je techniek (camera, microfoon, internetverbinding, de applicatie). Zorg voor goede verlichting van voren, een rustige achtergrond, gesloten notificaties en kleed je volledig professioneel. Kijk in de camera-lens als je praat, niet naar je eigen beeld op het scherm.',
        },
        {
            question: 'Moet ik een bedankmail sturen na een sollicitatiegesprek?',
            answer: 'Absoluut ja. Stuur binnen 24 uur een persoonlijke bedankmail. Slechts 24% van de kandidaten doet dit (CareerBuilder 2024). Bedank voor de tijd, herhaal kort je motivatie en benoem een concreet gespreksmoment. Dit is een van de makkelijkste manieren om positief op te vallen.',
        },
    ],
