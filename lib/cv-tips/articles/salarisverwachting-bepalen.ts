...
export const salarisverwachtingBepalen: BlogArticle = {
    ...
    keyTakeaways: [
        'Gebruik Loonwijzer, Glassdoor en CBS-data voor een onderbouwde salarisbasis voor je gesprek',
        'De EU loontransparantiewet (implementatiedeadline NL 2026) verplicht werkgevers salarissen te publiceren',
        'Noem altijd een bandbreedte van 5.000-8.000 euro — nooit een exact bedrag',
        'CareerBuilder (2024): 91% van werkgevers heeft onderhandelingsruimte bij het eerste aanbod',
        'Secundaire arbeidsvoorwaarden kunnen het totale pakket met 15-25% verhogen boven het bruto salaris',
    ],

    sections: [
        {
            id: 'waarom-salarisverwachting-belangrijk',
            title: 'Waarom je salarisverwachting goed voorbereiden?',
            answerCapsule: 'Een goed voorbereide salarisverwachting geeft je zelfvertrouwen en verhoogt het eindresultaat — 76% van onderhandelende kandidaten verdient meer dan het eerste aanbod (LinkedIn 2024).',
            content: [
        ...
        {
            id: 'marktconform-salaris-onderzoeken',
            title: 'Zo onderzoek je het marktconforme salaris',
            answerCapsule: 'Gebruik Loonwijzer, Glassdoor, CBS en sectorale cao-tabellen als primaire bronnen — combineer minimaal drie bronnen voor een betrouwbare salarisbasis.',
            content: [
        ...
        },
        {
            ...
            title: 'EU loontransparantiewet 2026: wat verandert er?',
            answerCapsule: 'De EU loontransparantierichtlijn (2023/970) verplicht Nederlandse werkgevers uiterlijk 2026 salarissen te publiceren — dit verandert de onderhandelingsdynamiek fundamenteel.',
            content: [
        ...
        {
            id: 'bandbreedte-bepalen',
            title: 'Een realistische salarisbandbreedte vaststellen',
            answerCapsule: 'Noem altijd een bandbreedte van 5.000-8.000 euro — de ondergrens is je realistisch minimum, de bovengrens is het marktconforme maximum voor jouw profiel.',
            content: [
        ...
        {
            id: 'timing-salarisgesprek',
            title: 'De juiste timing voor het salarisgesprek',
            answerCapsule: 'Laat de werkgever het onderwerp als eerste aansnijden — liefst pas in het tweede gesprek als je waarde al is aangetoond; een vroeg salarisdiscours verzwakt je positie.',
            content: [
        ...
        },
        {
            ...
            title: 'Je salarisverwachting professioneel communiceren',
            answerCapsule: 'Formuleer je verwachting met zelfvertrouwen en onderbouwing — verwijs naar marktcijfers, je ervaringsniveau en de specifieke waarde die je meebrengt aan de organisatie.',
            content: [
        ...
        {
            id: 'onderhandelen-strategie',
            title: 'Strategieën voor succesvolle salarisonderhandeling',
            answerCapsule: 'Het eerste bod is zelden het laatste bod — CareerBuilder (2024) bevestigt dat 91% van werkgevers onderhandelingsruimte heeft; gemiddeld resultaat is 10-15% boven het openingsbod.',
            content: [
        ...
        },
        {
            ...
            title: 'Secundaire arbeidsvoorwaarden: compleet overzicht',
            answerCapsule: 'Secundaire arbeidsvoorwaarden kunnen het totale pakket met 15-25% verhogen boven het bruto salaris — bereken de totale waarde voor je een aanbod beoordeelt.',
            content: [
        ...
        {
            id: 'thuiswerktoeslag-2026',
            title: 'Thuiswerktoeslag en het nieuwe pensioenstelsel in 2026',
            answerCapsule: 'De belastingvrije thuiswerktoeslag is €2,35 per dag in 2026 en het WTP-pensioenstelsel verandert de manier waarop pensioenbijdragen worden berekend — relevant voor salarisonderhandelingen.',
            content: [
        ...
        {
            id: 'valkuilen-vermijden',
            title: 'Valkuilen bij het bespreken van je salarisverwachting',
            answerCapsule: 'De drie grootste valkuilen: jezelf te laag inschatten, het eerste aanbod direct accepteren, en persoonlijke financiële redenen als argument gebruiken — alle drie vermijdbaar.',
            content: [
        ...
        {
            id: 'na-het-aanbod',
            title: 'Wat te doen na het ontvangen van een salarisaanbod',
            answerCapsule: 'Reageer altijd positief maar vraag om bedenktijd — evalueer het totale pakket schriftelijk, voer het tegenvoorstel telefonisch en onderbouw elk argument met marktcijfers.',
            content: [
    ...
    faq: [
        {
            question: 'Hoe bepaal ik mijn salarisverwachting als starter?',
            answer: 'Raadpleeg Loonwijzer, Glassdoor en cao-tabellen voor instapsalarissen in jouw sector en functie. UWV (2024) geeft aan dat hbo-starters gemiddeld €3.100 bruto per maand verdienen, wo-starters €3.600. Houd rekening met regio (Amsterdam is 10-15% hoger), sector en bedrijfsgrootte. Praat ook met alumni of medestudenten die recent zijn gestart.',
        },
        {
            question: 'Moet ik mijn huidige salaris delen als daarom gevraagd wordt?',
            answer: 'Nee. In Nederland bent u niet verplicht uw huidige salaris te delen. U kunt beleefd aangeven: "Ik richt me liever op de marktwaarde voor deze specifieke rol." De EU loontransparantiewet (implementatie 2026) versterkt dit principe: salarissen worden openbaar en uw vorige salaris is geen relevant referentiepunt meer.',
        },
        {
            question: 'Wat als het salarisaanbod lager is dan mijn verwachting?',
            answer: 'Niet meteen accepteren of afwijzen. Bedank voor het aanbod, vraag bedenktijd, en bereid een tegenvoorstel voor op basis van marktcijfers. CareerBuilder (2024) bevestigt dat 91% van werkgevers onderhandelingsruimte heeft. Het gemiddelde onderhandelingsresultaat is 10-15% boven het openingsbod (Glassdoor 2024).',
        },
        {
            question: 'Hoeveel onderhandelingsruimte is er gemiddeld?',
            answer: 'In Nederland ligt de ruimte gemiddeld tussen 5% en 15% boven het eerste aanbod, afhankelijk van sector en functieniveau. Bij cao-gebonden functies is de ruimte beperkter in het basissalaris, maar zijn er soms mogelijkheden in inschaling (hogere trede) of in secundaire voorwaarden. Start-ups en scale-ups hebben vaak meer flexibiliteit dan grote corporates.',
        },
        {
            question: 'Wat verandert de EU loontransparantiewet voor sollicitanten?',
            answer: 'De EU loontransparantierichtlijn (2023/970), te implementeren in Nederland voor juni 2026, verplicht werkgevers salarisranges te vermelden in vacatures en kandidaten recht te geven op informatie over interne salarisbanden. U kunt dan goed geïnformeerd onderhandelen zonder te raden wat het budget is.',
        },
        {
            question: 'Kan ik onderhandelen over secundaire arbeidsvoorwaarden?',
            answer: 'Absoluut. Secundaire arbeidsvoorwaarden zijn vaak makkelijker te onderhandelen dan het basissalaris. Denk aan extra vakantiedagen, thuiswerktoeslag (€2,35/dag belastingvrij in 2026), hoger opleidingsbudget, snellere salarisgroei na zes maanden, of een eenmalige tekeningbonus. Bereken de totale waarde van het pakket voor u beslist.',
        },
        {
            question: 'Moet ik salarisverwachting in mijn sollicitatiebrief vermelden?',
            answer: 'Alleen als de vacature er expliciet om vraagt. Vermeld het dan aan het einde van de brief als bandbreedte: "Mijn salarisverwachting ligt tussen €X en €Y bruto per jaar, afhankelijk van het totale pakket arbeidsvoorwaarden." Als de vacature er niet om vraagt, laat het weg — richt de brief volledig op motivatie en kwalificaties.',
        },
        {
            question: 'Hoe bespreek ik salaris in een online sollicitatiegesprek?',
            answer: 'Dezelfde principes gelden als bij een gesprek op locatie: laat de werkgever het onderwerp aansnijden, noem een bandbreedte met onderbouwing, vraag bedenktijd. Zorg dat uw verbinding stabiel is en dat u ongestoord kunt praten. Randstad (2024) bevestigt dat 70% van eerste gesprekken online plaatsvindt — bereid u technisch even goed voor als inhoudelijk.',
        },
    ],
